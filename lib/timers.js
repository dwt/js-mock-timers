...
;(function(){
  ...
  /**
   * IE Workaround. You cannot set global native functions directly but need to set them on the global object.
   * So this is a way to get it easily.
   */
  function global() {
    return this;
  }
  ...
  global().clearInterval = global().clearTimeout = function(id) {
